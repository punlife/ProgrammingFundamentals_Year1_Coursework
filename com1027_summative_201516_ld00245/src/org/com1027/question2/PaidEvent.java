...
public class PaidEvent {
   ...
   */
  public PaidEvent(String name, EventType eventType, int totalSeat) {
    this.name = name;
    this.eventType = eventType;
    this.totalNumberOfSeats = totalSeat;
  }
  ...
  // Method prints out the purchased number of tickets for the event, as well
  // as the number of tickets available.
