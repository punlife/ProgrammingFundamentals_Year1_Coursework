...
public class EventHistoryTest {
  ...
  public void testConstruction() throws Exception {
    ...
    PaidEventHistory eventHistory1 = new PaidEventHistory(organisation);
    assertNotNull(eventHistory1);
    assertEquals("Surrey University", eventHistory1.getOrganisation().getName());
  }
   ...
   */
  @Test
  public void testDisplayFreeandPaidEvents() throws Exception {
    Organisation organisation = new Organisation("Surrey University");
    FreeEventHistory eventHistory = new FreeEventHistory(organisation);
    PaidEventHistory eventHistory1 = new PaidEventHistory(organisation);
    ...
    eventHistory1.addPaidEvent(event4);
    eventHistory1.addPaidEvent(event5);
   ...
   */
  @Test
  public void testListOfSoldOutEvents() throws Exception {
    Organisation organisation = new Organisation("Surrey University");
    FreeEventHistory eventHistory = new FreeEventHistory(organisation);
    PaidEventHistory eventHistory1 = new PaidEventHistory(organisation);
    ...
    eventHistory1.addPaidEvent(paidEventObj);
    eventHistory1.addPaidEvent(paidEventObj2);
   ...
   */
  @Test
  public void testcalculateTotalTicketCostOfPaidEvents() throws Exception {
    Organisation organisation = new Organisation("Surrey University");
    PaidEventHistory eventHistory = new PaidEventHistory(organisation);
    ...
    assertEquals("wrong costs for paidEventObj", ((2 * 10) - (2 * 10 / 0.20)),
        paidEventObj.calculateTotalTicketCostOfPurchasedTickets("ABC"), 0);
    assertEquals("wrong costs for paidEventObj2", (3 * 10.0 - (3 * 10 / 0.20)),
        paidEventObj2.calculateTotalTicketCostOfPurchasedTickets("XYZ"), 0);

    // total cost should be 2 tickets at 10.0 for the first event object
    // and 3 tickets at 10.0 for the second event object
    assertEquals("wrong total cost", ((2 * 10.0) + (3 * 10.0)), eventHistory.calculateTotalTicketCostOfPaidEvents("Code"), 0);
  }
