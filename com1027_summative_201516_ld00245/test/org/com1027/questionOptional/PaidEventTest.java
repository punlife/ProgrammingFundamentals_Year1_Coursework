...
public class PaidEventTest {
  ...
  @Test
  public void testPaidConstruction() throws Exception {
    ...
    assertEquals(0, event.calculateTotalTicketCostOfPurchasedTickets("code"), 0);
  }
   ...
   */
  @Test
  public void calculateTotalTicketCostOfPurchasedTickets() throws Exception {
    // set up the map of prices for the different types of tickets
    Map<TicketType, Double> prices = new HashMap<>();
    prices.put(TicketType.MEMBER, 10.0);
    prices.put(TicketType.STUDENT, 5.0);
    ...
    assertEquals("wrong number purchased", ((5 * 10.0 + 4 * 5.0) - ((5 * 10.0 + 4 * 5.0) / 0.20)),
        event.calculateTotalTicketCostOfPurchasedTickets("ABC"), 0);
    ...
    assertEquals("wrong number purchased", (5 * 10.0 + 4 * 5.0 + 3 * 7.50),
        event.calculateTotalTicketCostOfPurchasedTickets("Code"), 0);
  }
